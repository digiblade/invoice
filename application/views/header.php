...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url("assets/");?>logo2.jpg" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url("assets/");?>index3.html" class="brand-link">
      <img src="<?php echo base_url("assets/");?>logo2.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Balaji Invoice</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url("assets/");?>logo2.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($main=='customer'){echo 'menu-open';}?>">
          <!-- <li class="nav-item menu-open"> -->
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item ">
                <a href="<?php echo base_url("front/createCustomer");?>" class="nav-link <?php if($main=='customer'&&$sub=="create"){echo 'active';}?>">
